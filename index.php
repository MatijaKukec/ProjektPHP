...
echo "<script> document.getElementById('index').classList.add('active'); 
  ...
  Form::Textbox('Korisnik: ', 'korisnik', array("required"=>1, "validation"=>new Validation_RegExp("/^[a-z\.\-\ ]{5,50}$/i","%element% mora sadržavati minimalno 5 znakova. Koriste se samo slova i brojke te _, - i .. Ostali znakovi interpunkcije nisu dozvoljeni")));
  Form::Password('Lozinka: ', 'lozinka', array("required"=>1, "validation"=>new Validation_RegExp("/^[a-z\.\-\ ]{6,60}$/i","%element% mora sadržavati minimalno 6 znakova. Koriste se samo slova i brojke te _, - i .. Ostali znakovi interpunkcije nisu dozvoljeni.")));
